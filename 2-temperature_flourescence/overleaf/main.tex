...
\begin{document}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\inverseGoldenRatio\pdfpagewidth]{experiment_diagram}
  ...
  \section*{Results}{
    ...
    \begin{figure}
        ...
        \caption{Natural logarithm of decay lifetime, $\ln(\tau),$ as a function of phosphor temperature, $T$, between \SI{-10}{\degreeCelsius} and \SI{100}{\degreeCelsius}.  Also included with errors as a table.} %TODO: actually include the table.
        \label{fig:tau-vs-T}
    \end{figure}
